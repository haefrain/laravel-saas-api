...
return [
    ...
    'description' => 'Multi-tenant team / projects / tasks REST API. All endpoints are versioned under /api/v1 and return data-wrapped JSON; errors use a consistent { message, error: { code, details } } envelope.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token via <code>POST /api/v1/auth/login</code> (or register first), then send it as <code>Authorization: Bearer {token}</code>.',
    ],
